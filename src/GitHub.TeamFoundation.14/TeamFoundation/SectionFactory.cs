...
namespace GitHub.VisualStudio.TeamExplorer
{
    ...
    public class SectionFactory
    {
        ...
        [ResolvingTeamExplorerSection("92655B52-360D-4BF5-95C5-D9E9E596AC76", "D0E4EA4E-24F0-46D6-9D07-0BC09CDEAE7D", 10)]
        public object Publish
        {
            get
            {
                return TeamFoundationResolver.Resolve(() =>
                    new GitHubPublishSection(serviceProvider, apiFactory, holder, manager, visualStudioBrowser, repositoryHosts));
            }
        }
    }
}
